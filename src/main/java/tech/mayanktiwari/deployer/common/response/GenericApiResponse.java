...
public class GenericApiResponse<T> {
  ...
  public static <T> GenericApiResponse<T> failure(
      String message, ErrorCode errorCode, String path) {
    return GenericApiResponse.<T>builder()
        .success(false)
        .message(message)
        .errorCode(errorCode.name())
  ...
  public static <T> GenericApiResponse<T> failure(
      String message, ErrorCode errorCode, String path, List<FieldValidationError> details) {
    return GenericApiResponse.<T>builder()
        .success(false)
        .message(message)
        .errorCode(errorCode.name())
