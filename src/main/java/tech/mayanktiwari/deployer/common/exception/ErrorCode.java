...
public enum ErrorCode {
    ...
    RESOURCE_ALREADY_EXISTS("A resource with the provided details already exists", HttpStatus.CONFLICT),
    ...
    METHOD_NOT_SUPPORTED("HTTP method not supported for this endpoint", HttpStatus.METHOD_NOT_ALLOWED),

    // Server
    INTERNAL_ERROR("An unexpected error occurred. Please try again later.", HttpStatus.INTERNAL_SERVER_ERROR);
